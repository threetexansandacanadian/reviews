...
const file = fs.createWriteStream('./database/data3.csv');
...
const generateData = () => {
  for (let i = 0; i < 10000000; i ++) {
    ...
    file.write(i + ',' + words1[index1] + ',' + words2[index2] + ',' + Math.floor(Math.random() * 5) + ',' + faker.date.between('01/01/2019','04/01/2019') + ',' + Math.floor(Math.random() * 10000000) + ',' + Math.floor(Math.random() * 100) + '\n');
  }
  file.end();
}
